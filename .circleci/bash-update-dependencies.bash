...
if [[ -n $(git status --porcelain) ]]; then
    ...
    curl -L -X POST -H "Accept: application/vnd.github+json" -H "Authorization: Bearer ${_ALL}" -H "X-GitHub-Api-Version: 2022-11-28" https://api.github.com/repos/WJ-van-Hoek/plugin-parent-pom/pulls -d '{"title":"AUTO-PR: update properties","head":"AUTO-UPDATE-DEPENDENCIES","base":"master"}'
